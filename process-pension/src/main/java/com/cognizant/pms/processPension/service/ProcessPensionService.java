...
public class ProcessPensionService {
    ...
    public PensionDetail processPension(String authToken, String aadhar) {
        ...
        ApiResponsePd pensionerDetails =  feignClient.getPensionerDetails(authToken, aadhar);
        ...
        Optional<PensionDetail> byAadharNo = pensionDetailRepository.findByAadharNo(aadhar);
        log.info("Data fetched:"+byAadharNo);
		...
		PensionDetail pensionDetail = new PensionDetail(aadhar, pensionAmount,
    ...
    public PensionDetail getPensionerDetailsByAadhar(String aadharNo) {
        ...
        if(byAadharNo.isPresent()){
            ...
            throw new ProcessPensionException("Aadhar no. not found in the db");
        }
    }
